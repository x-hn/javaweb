...
<body>
    ...
    <form action="${ctx}/categoryServlet?type=updatecategory" method="post">
    <input type="hidden" name="id" value="${obj.id}" />
	    <ul class="forminfo">
		    <li><label>分类名</label><input name="categoryName" type="text" class="dfinput" value="${obj.categoryName}" /><i>账号不能超过30个字符</i></li>
		    <li>
